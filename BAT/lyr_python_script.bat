@echo off
rem -------------------------------------------------------------------
rem lyr_python_script.bat [script]
rem -------------------------------------------------------------------
chcp 1251>NUL
...
:begin
    ...
    rem echo ..P1.. GET_script:!GET_script!
    echo script:!script!
    ...
    rem -------------------------------------------------------------------
    set FULL_SCRIPT_NAME=!scriptdir!!SCRIPT_NAME!
    if defined TEST (
        set FULL_SCRIPT_NAME=!scriptdir!!SCRIPT_NAME!
    )
    echo FULL_SCRIPT_NAME:!FULL_SCRIPT_NAME!
    if not exist !FULL_SCRIPT_NAME! (
        echo ERROR: script !FULL_SCRIPT_NAME! not exist ...
        exit /b 1
    )
    ...
    rem set APP=python %1 %2 %3 %4 %5 %6 %7 %8 %9
