...
:begin
       ...
       set PY_ENVDIR=!O2!
        ...
        if !02!==P313 (
            ...
            if !02!==P314 (
                ...
                set PY_ENVDIR=D:\PROJECTS_LYR\CHECK_LIST\DESKTOP\Python\VENV\!O2!
            )
        )
    )
    ...
    rem C:\Users\lyr\AppData\Local\Programs\Python\Python313\python.exe -m --upgrade venv D:\PROJECTS_LYR\CHECK_LIST\DESKTOP\Python\VENV\test

    rem python -m venv C:\path\to\new\virtual\environment
    rem The command, if run with -h, will show the available options:

    rem usage: venv [-h] [--system-site-packages] [--symlinks | --copies] [--clear]
    rem             [--upgrade] [--without-pip] [--prompt PROMPT] [--upgrade-deps]
    rem             [--without-scm-ignore-files]
    rem             ENV_DIR [ENV_DIR ...

    set APP=!PYTHON! -m venv --upgrade !PY_ENVDIR!
    echo APP:!APP!

    !PYTHON! -m venv --upgrade !PY_ENVDIR!
